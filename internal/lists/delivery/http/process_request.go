...
func (h handler) processGetRequest(c *gin.Context) (getReq, models.Scope, error) {
	...
	if !ok {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processGetRequest.jwt.GetPayloadFromContext: %v", "payload not found")
		return getReq{}, models.Scope{}, pkgErrors.NewUnauthorizedHTTPError()
	}

	var req getReq
	if err := c.ShouldBindQuery(&req); err != nil {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processGetRequest.c.ShouldBindQuery: %v", err)
		return getReq{}, models.Scope{}, errWrongQuery
	}

	req.PageQuery.Adjust()
	if err := req.validate(); err != nil {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processGetRequest.req.validate: %v", err)
		return getReq{}, models.Scope{}, errWrongQuery
	}
...
func (h handler) processCreateRequest(c *gin.Context) (createReq, models.Scope, error) {
	...
	p, ok := scope.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processCreateRequest.jwt.GetPayloadFromContext: %v", "payload not found")
...
func (h handler) processUpdateRequest(c *gin.Context) (updateReq, models.Scope, error) {
	...
	p, ok := scope.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processUpdateRequest.jwt.GetPayloadFromContext: %v", "payload not found")
		return updateReq{}, models.Scope{}, pkgErrors.NewUnauthorizedHTTPError()
	}

	var req updateReq
	if err := c.ShouldBindJSON(&req); err != nil {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processUpdateRequest.c.ShouldBindQuery: %v", err)
...
func (h handler) processDetailRequest(c *gin.Context) (string, models.Scope, error) {
	...
	p, ok := scope.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processDetailRequest.jwt.GetPayloadFromContext: %v", "payload not found")
...
func (h handler) processDeleteRequest(c *gin.Context) (deleteReq, models.Scope, error) {
	...
	var req deleteReq
	if err := c.ShouldBindJSON(&req); err != nil {
		h.l.Errorf(ctx, "internal.lists.delivery.http.processDeleteRequest.c.ShouldBindQuery: %v", err)
