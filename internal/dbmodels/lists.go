...
var (
	listAllColumns            = []string{"id", "board_id", "title", "position", "is_archived", "created_at", "updated_at", "deleted_at"}
	listColumnsWithoutDefault = []string{"board_id", "title", "position"}
	listColumnsWithDefault    = []string{"id", "is_archived", "created_at", "updated_at", "deleted_at"}
